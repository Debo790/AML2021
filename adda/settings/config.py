...
CLASSIFIER_MODEL_PATH_USPS = CLASSIFIER_MODEL_PATH + '/usps'
CLASSIFIER_MODEL_PATH_MNIST = CLASSIFIER_MODEL_PATH + '/mnist'
CLASSIFIER_MODEL_PATH_SVHN = CLASSIFIER_MODEL_PATH + '/svhn'
